...
// Build a Shape object with its properties
    ...
    int Shape::getXlocation() {return x_location;}           
    int Shape::getYlocation() {return y_location;}
    int Shape::getXsize() {return x_size;}              
    ...
    void Shape::setRotate(int angle) {rotation = angle;}
